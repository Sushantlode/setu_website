 ...
 * Local dev: leave VITE_API_URL empty and use relative paths proxied in vite.config.js.
 * Deployed: set VITE_API_URL=https://staging.setuai.com (or production host).
 */
